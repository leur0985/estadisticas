...
class EquiposController extends AppController
{
    ...
    public function view($id = null)
    {
        $equipo = $this->Equipos->get($id, [
            'contain' => ['Paises', 'Estadios', 'Puntos', 'Tecnicosequipostorneos', 'Torneos']
        ]);
    ...
    public function add()
    {
        ...
        $paises = $this->Equipos->Paises->find('list');
        $estadios = $this->Equipos->Estadios->find('list');
        $this->set(compact('equipo', 'paises', 'estadios'));
        $this->set('_serialize', ['equipo']);
    }
    ...
    public function edit($id = null)
    {
        ...
        $paises = $this->Equipos->Paises->find('list', ['limit' => 200]);
        $estadios = $this->Equipos->Estadios->find('list', ['limit' => 200]);
        $this->set(compact('equipo', 'paises', 'estadios'));
        $this->set('_serialize', ['equipo']);
    }
